...
/**
 * A lock with the same semantics【sɪ'mæntɪks 语义学，语义论】 as builtin Java synchronized locks: Once a
...
public class ReentrantLock implements Sync {
	...
	/**
	 * Release the lock N times. <code>release(n)</code> is equivalent in effect
	 * to:
	 * 
	 * <pre>
	 * for (int i = 0; i < n; ++i)
